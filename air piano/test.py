# Create a complete "Air Piano" project with Python script and requirements.txt

air_piano_code = r'''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
requirements = """opencv-python==4.10.0.84
mediapipe==0.10.14
numpy>=1.24
simpleaudio==1.0.4
"""

project_dir = "F:/tex/air_piano"
import os
os.makedirs(project_dir, exist_ok=True)
with open(os.path.join(project_dir, "air_piano.py"), "w", encoding="utf-8") as f:
    f.write(air_piano_code)
